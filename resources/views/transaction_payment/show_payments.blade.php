  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      @if($transaction->payment_status != 'paid')
        <div class="row">
          <div class="col-md-12">
          @if((auth()->user()->can('purchase.payments') && (in_array($transaction->type, ['purchase', 'purchase_return']) )) || (auth()->user()->can('sell.payments') && (in_array($transaction->type, ['sell', 'sell_return']))))
          ...
          <table class="table table-striped">
            ...
            @forelse ($payments as $payment)
                <tr>
                  ...
                  <td>{{ isset($payment_types[$payment->method]) ? $payment_types[$payment->method] : $payment->method }}</td>
                  <td>{{ $payment->note }}</td>
                  @if($accounts_enabled)
